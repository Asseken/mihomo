...
func (m *Manager) TotalDirectTraffic() (up, down int64) {
	return m.directUploadTotal.Load(), m.directDownloadTotal.Load()
}

func (m *Manager) NowDirectTraffic() (up, down int64) {
	return m.directUploadBlip.Load(), m.directDownloadBlip.Load()
}
